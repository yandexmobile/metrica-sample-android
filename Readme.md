...
*  Current relevant sample is **metrica-sample-android-2.20**.
...
* The last **mobmetricalib** library has the version `2.20` and the level of **API**  is `35`.  Thus in the **AndroidManifest.xml** you can see that the **metrica:api:level** value is equal to **35**.
...
*  Текущий действующий пример находится в папке **metrica-sample-android-2.20**.
...
* Данный пример использует библиотеку **mobmetricalib** версии `2.20` и уровнем **API** равным `35`. Поэтому в файле **AndroidManifest.xml** вы можете увидеть, что значение **metrica:api:level** равно **35**.
